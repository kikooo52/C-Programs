...
//            char[,] putBombs = CreateBombsField();
//            int count = 0;
//            bool thunder = false;
...
//        private static void RankList(List<Score> topScores)
//        {
//            Console.WriteLine("\nPoints:");
...
//                        i + 1, topScores[i].Име, topScores[i].То4ки);
//                }
//                Console.WriteLine();
//            }
//            else
...
//        private static void GetReading(char[,] POLE, char[,] BOMBI, int RED, int KOLONA)
//        {
//            char kolkoBombi = kolko(BOMBI, RED, KOLONA);
//            BOMBI[RED, KOLONA] = kolkoBombi;
//            POLE[RED, KOLONA] = kolkoBombi;
